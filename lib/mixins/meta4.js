...
module.exports = {
    ...
    beforeCreate: function(model, req, res, options) {
        ...
        DEBUG && console.log("[meta4foxx] meta4: beforeCreate: %o", model);
    },
    afterCreate: function(model, req, res, options) {
        DEBUG && console.log("[meta4foxx] meta4: afterCreate: %o", model);
        assert(model.meta4);
        return model;
    },
    beforeUpdate: function(model, req, res, options) {
        ...
        DEBUG && console.log("[meta4foxx] meta4: beforeUpdate: %o", model);
    },
    afterUpdate: function(model, req, res, options) {
        DEBUG && console.log("[meta4foxx] meta4: afterUpdate: %o", model);
        assert(model.meta4);
        return model;
    },
    beforeRead: function(model, req, res, options) {
        DEBUG && console.log("[meta4foxx] meta4: beforeRead: %o", model);
    },
    afterRead: function(model, req, res, options) {
        DEBUG && console.log("[meta4foxx] meta4: afterRead: %o", model);
        return model;
    },
    beforeDelete: function(model, req, res, options) {
        DEBUG && console.log("[meta4foxx] meta4: beforeDelete: %o", model);
    }
}
