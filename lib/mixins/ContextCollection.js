...
module.exports = {
    ...
    configure: function(options) {
        ...
        _.each(options.contextPath, function(ctx) {
            ...
            debug && console.log("ContextCollection: configure: %o", options.contextPath);
        })

        return options;
    },
    endpoint: function(endpoint, options) {
        DEBUG && console.log("ContextCollection: endpoint");
    },
    beforeRequest: function(filter, req, res, options) {
        ...
        DEBUG &&console.log("ContextCollection: beforeRequest: %o --> %o", req.queryParams, filter);
    },
    beforeCreate: function(model, req, res, options) {
        ...
        DEBUG && console.log("ContextCollection: beforeCreate: %o", model);
    },
    afterCreate: function(model, req, res, options) {
        DEBUG && console.log("ContextCollection: afterCreate: %o", model);
    },
    beforeUpdate: function(model, req, res, options) {
        ...
        DEBUG && console.log("ContextCollection: beforeUpdate: %o", model);
    },
    afterUpdate: function(model, req, res, options) {
        DEBUG && console.log("ContextCollection: afterUpdate: %o", model);
    },
    beforeRead: function(model, req, res, options) {
        DEBUG && console.log("ContextCollection: beforeRead: %o", model);
    },
    afterRead: function(model, req, res, options) {
        DEBUG && console.log("ContextCollection: afterRead: %o", model);
    },
    beforeDelete: function(model, req, res, options) {
        DEBUG && console.log("ContextCollection: beforeDelete: %o", model);
    }
}
