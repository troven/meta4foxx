...
module.exports = function(scoped, options) {
    ...
    var CanScope = function(_verbs) {
        ...
        DEBUG && console.log("[meta4foxx] _verbs: %o", _verbs);
    ...
    DEBUG && console.log("[meta4foxx] VERBS: %o", verbs)
    CanScope(verbs);
    ...
    var RBAC = {
        ...
        protect: function(fn) {
            ...
            return function(req, res) {
                if (is_scoped) {
                    console.log("[meta4foxx] rbac protect?: %o --> %o", req.method, req.path);
        ...
        authorize: function(jwt, req) {
            ...
            DEBUG && console.log("[meta4foxx] rbac jwt roles: %o", roles);
            ...
            DEBUG && console.log("[meta4foxx] rbac authorizes: %o --> %s --> %o", roles, scoped, matched);
            ...
            return {
                ...
                can: function(action, resource) {
                    ...
                    if (!jwt) {
                        DEBUG && console.log("[meta4foxx] rbac no-jwt: %s --> %o", action, resource);
                        return false;
                    }
                    var granted = matched.indexOf?matched.indexOf(action)>=0:matched[action]?true:false;
                    DEBUG && console.log("[meta4foxx] rbac granted?: %s --> %s --> %o", action, matched, granted);
                    return granted;
                }
